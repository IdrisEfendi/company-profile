        ...
        plugins: {
            tenor: {
                init: function (trumbowyg) {
                    trumbowyg.o.plugins.tenor = $.extend({}, defaultOptions, trumbowyg.o.plugins.tenor || {});
                    ...
                    trumbowyg.addBtnDef('tenor', {
                        fn: function () {
                            ...
                            var BASE_URL = 'https://g.tenor.com/v2/search?ar_range=all&media_filter=gif,tinygif&limit=10&key=' + trumbowyg.o.plugins.tenor.apiKey + '&locale=' + trumbowyg.o.plugins.tenor.locale + '&contentfilter=' + trumbowyg.o.plugins.tenor.contentFilter;
                            ...
                            trumbowyg.openModal(null, tenorModalHtml, false).one(CANCEL_EVENT, function () {
                                try {
