    ...
    function buildButtonDef(trumbowyg) {
        ...
        return {
            ...
            fn: function () {
                ...
                setTimeout(() => {
                    trumbowyg.saveRange();
                    if (trumbowyg.range.startContainer === trumbowyg.range.endContainer && trumbowyg.range.startContainer.nodeName === 'P' && trumbowyg.range.startContainer.innerText.trim() === '') {
        ...
        plugins: {
            speechRecognition: {
                ...
                init: function (trumbowyg) {
                    trumbowyg.o.plugins.speechRecognition = $.extend(true, {}, defaultOptions, trumbowyg.o.plugins.speechRecognition || {});
