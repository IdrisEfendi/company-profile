                ...
                init: function (trumbowyg) {
                    ...
                    trumbowyg.addBtnDef('giphy', {
                        fn: function () {
                            ...
                            var BASE_URL = ['https://api.giphy.com/v1/gifs/search?api_key=', trumbowyg.o.plugins.giphy.apiKey, '&rating=', trumbowyg.o.plugins.giphy.rating, '&limit=', trumbowyg.o.plugins.giphy.limit, '&bundle=', GIPHY_OPTIONS.bundle].join('');
