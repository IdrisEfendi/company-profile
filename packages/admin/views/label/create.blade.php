...
@section('content')
    ...
    <div class="space-y-4">
        <div class="flex gap-4 items-center">
            <h1 class="text-2xl font-medium">Create label</h1>
        </div>
                    ...
                    <div class="col-span-12 md:col-span-8">
                        <div class="grid grid-cols-12 gap-x-6 gap-y-2 border rounded-md p-4 bg-white">
                            ...
                            <div class="col-span-12">
                                ...
                                <div class="mt-1">
                                    <textarea name="description" id="description" rows="4" class="block w-full rounded-md border-0 py-1.5 text-c0-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-c0-400 focus:ring-2 focus:ring-inset focus:ring-c1-600 sm:text-sm sm:leading-6">{{ old('description') ?? '' }}</textarea>
