                            ...
                            <div class="col-span-6">
                                ...
                                <div class="mt-1">
                                    <input type="text" name="username" id="username" autocomplete="off"
                                        value="{{ old('username') ?? $username }}" placeholder="Enter username"
                                    ...
                                    <select name="role" id="role"
                                        ...
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->id }}"
                                                {{ $role_id == $role->id || old('role') == $role->id ? 'selected' : '' }}>
                                                {{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('role'))
                                ...
                                <div class="mt-1">
                                    <div class="relative">
                                        <input type="password" name="confirm_password" id="confirm-password"
                                            value="{{ old('confirm-password') ?? '' }}" placeholder="*****" autocomplete="off"
                                            class="block w-full rounded-md border-0 py-1.5 text-c0-900 shadow-sm ring-1 ring-inset ring-c0-300 placeholder:text-c0-400 focus:ring-2 focus:ring-inset focus:ring-c1-600 sm:text-sm sm:leading-6">
                                        <span
                                            class="btn-toggle-password absolute top-0 right-0 text-c0-800 flex h-full items-center px-2 cursor-pointer hover:text-c1-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            <div class="col-span-12">
                                ...
                                <div class="mt-1">
                                    <textarea name="biodata" id="biodata" rows="4" placeholder="Enter biodata"
                                        class="block w-full rounded-md border-0 py-1.5  shadow-sm ring-1 ring-inset ring-c0-300 placeholder:text-c0-400 focus:ring-2 focus:ring-inset focus:ring-c1-600 sm:text-sm sm:leading-6">{{ old('biodata') ?? $biodata }}</textarea>
