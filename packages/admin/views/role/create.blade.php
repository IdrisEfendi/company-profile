                            ...
                            <div class="col-span-12">
                                ...
                                <div class="mt-1">
                                    <textarea name="description" id="description" rows="4" placeholder="Enter description"
                                        class="block w-full rounded-md border-0 py-1.5  shadow-sm ring-1 ring-inset ring-c0-300 placeholder:text-c0-400 focus:ring-2 focus:ring-inset focus:ring-c1-600 sm:text-sm sm:leading-6">{{ old('description') ?? '' }}</textarea>
