<div id="modal-karyawan" class="modal relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 w-full text-center sm:mt-0 sm:text-left space-y-3">
                        <div class="flex gap-2 items-center w-full justify-between">
                            ...
                            <a download" href="{{ home_url() }}/assets/packages/admin/template/template-karyawan.xlsx?{{ time() }}"
                        ...
                        <div class="mt-2">
                            <form method="POST" action="{{ route('admin-karyawan-upload-store') }}" enctype="multipart/form-data" class="grid gap-4 grid-cols-12">
                                @csrf
                                ...
                                <div class="col-span-12">
                                    <div class="flex justify-end gap-2 items-center">
                                        <button type="button"
                                            class="btn-remove-modal-karyawan mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Cancel</button>
                                        <button type="submit" name="inp_save_karyawan"
