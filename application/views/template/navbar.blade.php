...
<header class="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/90">
    <div class="mx-auto flex h-20 max-w-7xl items-center justify-between gap-5 px-4 sm:px-6 lg:px-8">
        <a href="#beranda" class="flex min-w-0 items-center gap-3" aria-label="PT BPR Karawang Jabar">
        ...
        <nav class="hidden items-center gap-1 text-sm font-bold text-slate-600 lg:flex dark:text-slate-300" aria-label="Navigasi utama">
            <a class="rounded-app px-3 py-2 hover:bg-slate-100 hover:text-brand-700 dark:hover:bg-white/10 dark:hover:text-white" href="#tentang">Tentang</a>
            <a class="rounded-app px-3 py-2 hover:bg-slate-100 hover:text-brand-700 dark:hover:bg-white/10 dark:hover:text-white" href="#layanan">Layanan</a>
            <a class="rounded-app px-3 py-2 hover:bg-slate-100 hover:text-brand-700 dark:hover:bg-white/10 dark:hover:text-white" href="#nilai">Nilai</a>
            <a class="rounded-app px-3 py-2 hover:bg-slate-100 hover:text-brand-700 dark:hover:bg-white/10 dark:hover:text-white" href="#kontak">Kontak</a>
        </nav>
